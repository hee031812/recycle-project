...
<div class="universe">
    ...
    <div class="mouse__scroll">
        <div class="container">
            ...
            <a class="text" href="#clickMe">
                See it in action
                <div class="chevrongroup">
    ...
    <div class="clickMe" id="clickMe">
        <div class="clickmewrap">
            <a href="php/main/main.php" class="cta">
                <svg width="13px" height="10px" viewBox="0 0 13 10">
                    <path d="M1,5 L11,5"></path>
                    <polyline points="8 1 12 5 8 9"></polyline>
                </svg>
                <a href="php/main/main.php"><span>Click me</span></a>
            </a>
        </div>
    </div>
    ...
    <script>
        ...
        ani7.from("#section7 .t1", { autoAlpha: 0, duration: 3, y: 50}, "+=1")
        ani7.from("#section7 .t2", { autoAlpha: 0, duration: 3, y: 50}, "+=1")
        ani7.from("#section7 .t3", { autoAlpha: 0, duration: 3, y: 50}, "+=1")
        ani7.from("#section7 .t4", { autoAlpha: 0, duration: 3, y: 50}, "+=1")
        ani7.from("#section7 .t5", { autoAlpha: 0, duration: 3, y: 50}, "+=1")
        ani7.from("#section7 .t6", { autoAlpha: 0, duration: 3, y: 50}, "+=1")
